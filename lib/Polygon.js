...
var controlledPropTypes = {
  ...
  onPathChange: _react.PropTypes.any,
}; /* global google */
...
function getInstanceFromComponent(component) {
  if (component.props.onPathChange) {
    var tempPath = component.state[_constants.POLYLINE].getPath()
    if (tempPath.length > 0) {
      component.props.onPathChange(tempPath)
    }
  }
